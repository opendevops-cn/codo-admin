...
from libs.object_storage import OSSApi
...
class StorageCOSPrivate(BaseHandler):
...
storage_urls = [
    ...
    (r"/v4/storage/cos/private/", StorageCOSPrivate,
     {"handle_name": "PAAS-基础功能-存储COS-私有", "method": ["ALL"]}),
